...
function initTeamSelector() {
    ...
    const button = document.getElementById('teamSelectorButton');

    const dropdown = document.getElementById('teamDropdown');

    const title = document.getElementById('selectedTeamTitle');

    const placeholder =
        document.getElementById('teamPlaceholder');
    ...
    // If this isn't the team page, stop here.
    if (
        !selector ||
        !button ||
        !dropdown ||
    ...
    options.forEach(option => {
        ...
        option.addEventListener('click', () => {
            ...
            if (selectedPanel) {
                ...
                // Small delay so scrolling feels natural.
                setTimeout(() => {
